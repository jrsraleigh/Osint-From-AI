...
export const GLOBAL_SOCIAL_NSFW_DORK = 'site:instagram.com+OR+site:facebook.com+OR+site:twitter.com+OR+site:linkedin.com+OR+site:pinterest.com+OR+site:reddit.com+OR+site:github.com+OR+site:flickr.com+OR+site:vimeo.com+OR+site:soundcloud.com+OR+site:behance.net+OR+site:dribbble.com+OR+site:medium.com+OR+site:quora.com+OR+site:tumblr.com+OR+site:snapchat.com+OR+site:tiktok.com+OR+site:twitch.tv+OR+site:discord.com+OR+site:pornhub.com+OR+site:xvideos.com+OR+site:xnxx.com+OR+site:xhamster.com+OR+site:onlyfans.com+OR+site:fansly.com+OR+site:chaturbate.com+OR+site:cam4.com+OR+site:bongacams.com+OR+site:stripchat.com+OR+site:livejasmin.com+OR+site:manyvids.com+OR+site:clips4sale.com+OR+site:modelcenter.com+OR+site:iwantclips.com+OR+site:loyalfans.com+OR+site:pocketstars.com+OR+site:avn.com+OR+site:adultempire.com+OR+site:brazzers.com+OR+site:realitykings.com+OR+site:bangbros.com+OR+site:naughtyamerica.com+OR+site:porn.com+OR+site:redtube.com+OR+site:youporn.com+OR+site:tube8.com+OR+site:spankbang.com+OR+site:eporner.com+OR+site:tnaflix.com+OR+site:motherless.com+OR+site:heavy-r.com+OR+site:efukt.com+OR+site:documentingreality.com+OR+site:theync.com+OR+site:kaotic.com+OR+site:goregrish.com+OR+site:crazyshit.com+OR+site:fapello.com+OR+site:thothub.to+OR+site:coomer.party+OR+site:kemono.party+OR+site:simpcity.su+OR+site:vipergirls.to+OR+site:planetsuzy.org+OR+site:rule34.xxx+OR+site:gelbooru.com+OR+site:danbooru.donmai.us+OR+site:e621.net+OR+site:furaffinity.net+OR+site:inkbunny.net+OR+site:pixiv.net+OR+site:hentai-foundry.com+OR+site:nhentai.net+OR+site:hitomi.la+OR+site:tsumino.com+OR+site:pururin.to+OR+site:e-hentai.org+OR+site:hanime.tv+OR+site:hentaihaven.xxx+OR+site:multporn.net+OR+site:8muses.com+OR+site:doujins.com+OR+site:mastodon.social+OR+site:threads.net+OR+site:bluesky.social+OR+site:cohost.org+OR+site:post.news+OR+site:t2.social+OR+site:hive.social+OR+site:counter.social+OR+site:gab.com+OR+site:truthsocial.com+OR+site:parler.com+OR+site:gettr.com+OR+site:rumble.com+OR+site:odysee.com+OR+site:bitchute.com+OR+site:dailymotion.com+OR+site:bandcamp.com+OR+site:mixcloud.com+OR+site:last.fm+OR+site:discogs.com+OR+site:letterboxd.com+OR+site:goodreads.com+OR+site:storygraph.com+OR+site:librarything.com+OR+site:rateyourmusic.com+OR+site:myanimelist.net+OR+site:anilist.co+OR+site:kitsu.io+OR+site:deviantart.com+OR+site:artstation.com+OR+site:500px.com+OR+site:unsplash.com+OR+site:pexels.com+OR+site:pixabay.com+OR+site:shutterstock.com+OR+site:adobe.com+OR+site:canva.com+OR+site:figma.com+OR+site:sketch.com+OR+site:invisionapp.com+OR+site:zeplin.io+OR+site:abstract.com+OR+site:framer.com+OR+site:webflow.com+OR+site:bubble.io+OR+site:glideapps.com+OR+site:adalo.com+OR+site:zapier.com+OR+site:make.com+OR+site:ifttt.com+OR+site:notion.so+OR+site:obsidian.md+OR+site:roamresearch.com+OR+site:logseq.com+OR+site:evernote.com+OR+site:onenote.com+OR+site:keep.google.com+OR+site:slack.com+OR+site:zoom.us+OR+site:microsoft.com+OR+site:apple.com+OR+site:amazon.com+OR+site:ebay.com+OR+site:etsy.com+OR+site:shopify.com+OR+site:gumroad.com+OR+site:patreon.com+OR+site:buymeacoffee.com+OR+site:ko-fi.com+OR+site:substack.com+OR+site:ghost.org+OR+site:wordpress.com+OR+site:blogger.com+OR+site:livejournal.com+OR+site:dreamwidth.org+OR+site:pillowfort.social+OR+site:plurk.com+OR+site:weibo.com+OR+site:baidu.com+OR+site:zhihu.com+OR+site:douban.com+OR+site:xiaohongshu.com+OR+site:bilibili.com+OR+site:vk.com+OR+site:ok.ru+OR+site:telegram.org+OR+site:signal.org+OR+site:whatsapp.com+OR+site:line.me+OR+site:kakao.com+OR+site:viber.com+OR+site:skype.com+OR+site:meetup.com+OR+site:adultwork.com+OR+site:escort-directory.com+OR+site:eurogirlsescort.com+OR+site:slixa.com+OR+site:eros.com+OR+site:yesbackpage.com+OR+site:bedpage.com+OR+site:cityxguide.com+OR+site:rubratings.com+OR+site:massageanywhere.com+OR+site:listcrawler.com+OR+site:skipthegames.com+OR+site:megapersons.com+OR+site:locanto.com+OR+site:craigslist.org+OR+site:doublelist.com+OR+site:squirt.org+OR+site:adam4adam.com+OR+site:scruff.com+OR+site:grindr.com+OR+site:tinder.com+OR+site:bumble.com+OR+site:hinge.co+OR+site:okcupid.com+OR+site:pof.com+OR+site:match.com+OR+site:zoosk.com+OR+site:badoo.com+OR+site:tagged.com+OR+site:hi5.com+OR+site:meetme.com+OR+site:skout.com+OR+site:lovoo.com+OR+site:jaumo.com+OR+site:mamba.ru+OR+site:badoodata.com+OR+site:ashleymadison.com+OR+site:seeking.com+OR+site:sugarbook.com+OR+site:secretbenefits.com+OR+site:whatsyourprice.com+OR+site:missy.com+OR+site:adultfriendfinder.com+OR+site:alt.com+OR+site:fetlife.com+OR+site:recon.com+OR+site:kink.com+OR+site:modelmayhem.com+OR+site:purpleport.com+OR+site:star-now.com+OR+site:castingcall.club+OR+site:backstage.com+OR+site:fiverr.com+OR+site:upwork.com+OR+site:freelancer.com+OR+site:guru.com+OR+site:peopleperhour.com+OR+site:toptal.com+OR+site:99designs.com+OR+site:envato.com+OR+site:creativemarket.com+OR+site:unity.com+OR+site:unrealengine.com+OR+site:roblox.com+OR+site:minecraft.net+OR+site:steamcommunity.com+OR+site:epicgames.com+OR+site:gog.com+OR+site:origin.com+OR+site:uplay.com+OR+site:battle.net+OR+site:nintendo.com+OR+site:playstation.com+OR+site:xbox.com+OR+site:kick.com+OR+site:trovo.live+OR+site:dlive.tv+OR+site:caffeine.tv+OR+site:younow.com+OR+site:bigo.tv+OR+site:tango.me+OR+site:micochat.com+OR+site:azar.com+OR+site:holla.world+OR+site:monkey.app+OR+site:chatroulette.com+OR+site:tinychat.com+OR+site:camfrog.com+OR+site:paltalk.com+OR+site:icq.com+OR+site:mirc.com+OR+site:hexchat.github.io+OR+site:quassel-irc.org+OR+site:rambler.ru+OR+site:proton.me+OR+site:tutanota.com+OR+site:zoomeye.org+OR+site:shodan.io+OR+site:censys.io+OR+site:fofa.info+OR+site:hunter.how+OR+site:onyphe.io+OR+site:binaryedge.io+OR+site:wigle.net+OR+site:intelx.io+OR+site:dehashed.com+OR+site:snusbase.com+OR+site:psbdmp.ws+OR+site:pastebin.com+OR+site:ghostbin.com+OR+site:hastebin.com+OR+site:controlc.com+OR+site:justpaste.it+OR+site:rentmen.eu+OR+site:escortalligator.com+OR+site:eros-guide.com+OR+site:adultsearch.com+OR+site:myfreecams.com+OR+site:imlive.com+OR+site:faphouse.com+OR+site:porntrex.com+OR+site:daftsex.com+OR+site:hqporner.com+OR+site:xhamsterlive.com+OR+site:camzap.com+OR+site:chatrandom.com+OR+site:bazoocam.org+OR+site:dirtyroulette.com+OR+site:camsurf.com+OR+site:shagle.com+OR+site:emeraldchat.com+OR+site:ome.tv+OR+site:coomeet.com+OR+site:flingster.com+OR+site:adultchat.com+OR+site:sex.com+OR+site:alltrails.com+OR+site:strava.com+OR+site:komoot.com+OR+site:wikiloc.com+OR+site:geocaching.com+OR+site:ingress.com+OR+site:pokemon.com+OR+site:duolingo.com+OR+site:memrise.com+OR+site:babbel.com+OR+site:busuu.com+OR+site:italki.com+OR+site:preply.com+OR+site:verbling.com+OR+site:hellotalk.com+OR+site:tandem.net+OR+site:couchsurfing.com+OR+site:trustpilot.com+OR+site:yelp.com+OR+site:tripadvisor.com+OR+site:foursquare.com+OR+site:untappd.com+OR+site:vivino.com+OR+site:cellartracker.com+OR+site:beeradvocate.com+OR+site:ratebeer.com+OR+site:allrecipes.com+OR+site:cookpad.com+OR+site:yummly.com+OR+site:tasty.co+OR+site:food52.com+OR+site:epicurious.com+OR+site:bonappetit.com+OR+site:seriouseats.com+OR+site:thekitchn.com+OR+site:apartmenttherapy.com+OR+site:houzz.com+OR+site:zillow.com+OR+site:redfin.com+OR+site:realtor.com+OR+site:trulia.com+OR+site:streetclams.com+OR+site:city-data.com+OR+site:topix.com+OR+site:fark.com+OR+site:slashdot.org+OR+site:digg.com+OR+site:newsvine.com+OR+site:mewe.com+OR+site:vero.co+OR+site:ello.co+OR+site:steemit.com+OR+site:minds.com+OR+site:crunchbase.com+OR+site:glassdoor.com+OR+site:indeed.com+OR+site:monster.com+OR+site:careerbuilder.com+OR+site:ziprecruiter.com+OR+site:simplyhired.com+OR+site:dice.com+OR+site:hired.com+OR+site:triplebyte.com+OR+site:remote.com+OR+site:weworkremotely.com+OR+site:flexjobs.com+OR+site:remotive.io+OR+site:jobspresso.co+OR+site:outsourcely.com+OR+site:hubstafftalent.com+OR+site:jsfiddle.net+OR+site:stackblitz.com+OR+site:replit.com+OR+site:glitch.com+OR+site:codesandbox.io+OR+site:sourceforge.net+OR+site:launchpad.net+OR+site:gitee.com+OR+site:coding.net+OR+site:dev.to+OR+site:hashnode.com+OR+site:hackernoon.com+OR+site:freecodecamp.org+OR+site:codecademy.com+OR+site:coursera.org+OR+site:edx.org+OR+site:udacity.com+OR+site:udemy.com+OR+site:pluralsight.com+OR+site:skillshare.com+OR+site:masterclass.com+OR+site:khanacademy.org+OR+site:youjizz.com+OR+site:spankbang.com+OR+site:xtube.com+OR+site:pornerbros.com+OR+site:pornhd.com+OR+site:pornrabbit.com+OR+site:pornmd.com+OR+site:porndig.com+OR+site:porndrive.com+OR+site:pornheed.com+OR+site:pornkee.com+OR+site:pornkyu.com+OR+site:pornluv.com+OR+site:pornmuz.com+OR+site:pornoat.com+OR+site:pornpics.com+OR+site:pornrox.com+OR+site:pornstar.com+OR+site:porntube.com+OR+site:pornvibe.com+OR+site:pornx.com+OR+site:pornz.com+OR+site:speedrun.com+OR+site:nexusmods.com+OR+site:curseforge.com+OR+site:moddb.com+OR+site:gamejolt.com+OR+site:itch.io+OR+site:kongregate.com+OR+site:newgrounds.com+OR+site:armorgames.com+OR+site:miniclip.com+OR+site:ubisoftconnect.com+OR+site:socialclub.rockstargames.com+OR+site:worldofwarcraft.com+OR+site:tracker.gg+OR+site:bungie.net+OR+site:pathofexile.com+OR+site:forums.warframe.com+OR+site:evewho.com+OR+site:opensea.io+OR+site:rarible.com+OR+site:foundation.app+OR+site:superrare.com+OR+site:looksrare.org+OR+site:magiceden.io+OR+site:coinmarketcap.com+OR+site:binance.com+OR+site:coinbase.com+OR+site:fitbit.com+OR+site:connect.garmin.com+OR+site:myfitnesspal.com+OR+site:trainingpeaks.com+OR+site:mapmyrun.com+OR+site:runkeeper.com+OR+site:onepeloton.com+OR+site:zwift.com+OR+site:chess.com+OR+site:lichess.org+OR+site:boardgamegeek.com+OR+site:reverbnation.com+OR+site:audiomack.com+OR+site:spotify.com+OR+site:deezer.com+OR+site:tidal.com+OR+site:forum.xda-developers.com+OR+site:forums.macrumors.com+OR+site:overclock.net+OR+site:linustechtips.com+OR+site:forums.tomshardware.com+OR+site:neowin.net+OR+site:hardforum.com+OR+site:forums.guru3d.com+OR+site:techpowerup.com+OR+site:pcpartpicker.com+OR+site:head-fi.org+OR+site:avsforum.com+OR+site:blu-ray.com+OR+site:forums.digitalspy.com+OR+site:pistonheads.com+OR+site:bimmerpost.com+OR+site:rennlist.com+OR+site:teslamotorsclub.com+OR+site:flyertalk.com+OR+site:nomadlist.com+OR+site:internations.org+OR+site:expat.com+OR+site:eventbrite.com+OR+site:mofos.com+OR+site:babes.com+OR+site:twistys.com+OR+site:trueamateur.com+OR+site:digitalplayground.com+OR+site:men.com+OR+site:seancody.com+OR+site:belami.com+OR+site:corbinfisher.com+OR+site:nextdoorstudios.com+OR+site:helixstudios.com+OR+site:falconstudios.com+OR+site:lucasentertainment.com+OR+site:cockyboys.com+OR+site:treasureislandmedia.com+OR+site:mix.com+OR+site:weheartit.com+OR+site:letterboxd.com+OR+site:app.thestorygraph.com+OR+site:librarything.com+OR+site:rateyourmusic.com+OR+site:anilist.co+OR+site:kitsu.io+OR+site:clapperapp.com+OR+site:triller.co+OR+site:parler.com+OR+site:gab.com+OR+site:minds.com+OR+site:bitchute.com+OR+site:rumble.com+OR+site:odysee.com+OR+site:brighteon.com+OR+site:brandnewtube.com+OR+site:ugetube.com+OR+site:newtube.app+OR+site:bastyon.com+OR+site:pocketnet.app+OR+site:flote.app+OR+site:clout-hub.com+OR+site:usa.life+OR+site:social.quodverum.com+OR+site:poal.co+OR+site:saidit.net+OR+site:ruqqus.com+OR+site:voat.co+OR+site:communities.win+OR+site:patriots.win+OR+site:greatawakening.win+OR+site:kotakuinaction2.win+OR+site:conspiracies.win+OR+site:nonewnormal.win+OR+site:donaldjtrump.com+OR+site:truthsocial.com+OR+site:gettr.com+OR+site:frankspeech.com+OR+site:clouthub.com+OR+site:locals.com+OR+site:subscribestar.com+OR+site:fanbox.com+OR+site:pixiv.net+OR+site:fanbox.cc+OR+site:fantia.jp+OR+site:ci-en.dlsite.com+OR+site:skeb.jp+OR+site:enty.jp+OR+site:creatia.cc+OR+site:myfans.jp+OR+site:candfans.jp+OR+site:fantia.jp+OR+site:fanly.jp+OR+site:onlyfans.com+OR+site:fansly.com+OR+site:pocketstars.com+OR+site:loyalfans.com+OR+site:modelcenter.com+OR+site:manyvids.com+OR+site:clips4sale.com+OR+site:iwantclips.com+OR+site:adultempire.com+OR+site:avn.com+OR+site:adultwork.com+OR+site:escort-directory.com+OR+site:eurogirlsescort.com+OR+site:slixa.com+OR+site:eros.com+OR+site:yesbackpage.com+OR+site:bedpage.com+OR+site:cityxguide.com+OR+site:rubratings.com+OR+site:massageanywhere.com+OR+site:listcrawler.com+OR+site:skipthegames.com+OR+site:megapersons.com+OR+site:locanto.com+OR+site:craigslist.org+OR+site:doublelist.com+OR+site:squirt.org+OR+site:adam4adam.com+OR+site:scruff.com+OR+site:grindr.com+OR+site:tinder.com+OR+site:bumble.com+OR+site:hinge.co+OR+site:okcupid.com+OR+site:pof.com+OR+site:match.com+OR+site:zoosk.com+OR+site:badoo.com+OR+site:tagged.com+OR+site:hi5.com+OR+site:meetme.com+OR+site:skout.com+OR+site:lovoo.com+OR+site:jaumo.com+OR+site:mamba.ru+OR+site:badoodata.com+OR+site:ashleymadison.com+OR+site:seeking.com+OR+site:sugarbook.com+OR+site:secretbenefits.com+OR+site:whatsyourprice.com+OR+site:missy.com+OR+site:adultfriendfinder.com+OR+site:alt.com+OR+site:fetlife.com+OR+site:recon.com+OR+site:kink.com+OR+site:modelmayhem.com+OR+site:purpleport.com+OR+site:star-now.com+OR+site:castingcall.club+OR+site:backstage.com+OR+site:fiverr.com+OR+site:upwork.com+OR+site:freelancer.com+OR+site:guru.com+OR+site:peopleperhour.com+OR+site:toptal.com+OR+site:99designs.com+OR+site:envato.com+OR+site:creativemarket.com+OR+site:unity.com+OR+site:unrealengine.com+OR+site:roblox.com+OR+site:minecraft.net+OR+site:steamcommunity.com+OR+site:epicgames.com+OR+site:gog.com+OR+site:origin.com+OR+site:uplay.com+OR+site:battle.net+OR+site:nintendo.com+OR+site:playstation.com+OR+site:xbox.com+OR+site:kick.com+OR+site:trovo.live+OR+site:dlive.tv+OR+site:caffeine.tv+OR+site:younow.com+OR+site:bigo.tv+OR+site:tango.me+OR+site:micochat.com+OR+site:azar.com+OR+site:holla.world+OR+site:monkey.app+OR+site:chatroulette.com+OR+site:tinychat.com+OR+site:camfrog.com+OR+site:paltalk.com+OR+site:icq.com+OR+site:mirc.com+OR+site:hexchat.github.io+OR+site:quassel-irc.org+OR+site:rambler.ru+OR+site:proton.me+OR+site:tutanota.com+OR+site:zoomeye.org+OR+site:shodan.io+OR+site:censys.io+OR+site:fofa.info+OR+site:hunter.how+OR+site:onyphe.io+OR+site:binaryedge.io+OR+site:wigle.net+OR+site:intelx.io+OR+site:dehashed.com+OR+site:snusbase.com+OR+site:psbdmp.ws+OR+site:pastebin.com+OR+site:ghostbin.com+OR+site:hastebin.com+OR+site:controlc.com+OR+site:justpaste.it+OR+site:rentmen.eu+OR+site:escortalligator.com+OR+site:eros-guide.com+OR+site:adultsearch.com+OR+site:myfreecams.com+OR+site:imlive.com+OR+site:faphouse.com+OR+site:porntrex.com+OR+site:daftsex.com+OR+site:hqporner.com+OR+site:xhamsterlive.com+OR+site:camzap.com+OR+site:chatrandom.com+OR+site:bazoocam.org+OR+site:dirtyroulette.com+OR+site:camsurf.com+OR+site:shagle.com+OR+site:emeraldchat.com+OR+site:ome.tv+OR+site:coomeet.com+OR+site:flingster.com+OR+site:adultchat.com+OR+site:sex.com+OR+site:alltrails.com+OR+site:strava.com+OR+site:komoot.com+OR+site:wikiloc.com+OR+site:geocaching.com+OR+site:ingress.com+OR+site:pokemon.com+OR+site:duolingo.com+OR+site:memrise.com+OR+site:babbel.com+OR+site:busuu.com+OR+site:italki.com+OR+site:preply.com+OR+site:verbling.com+OR+site:hellotalk.com+OR+site:tandem.net+OR+site:couchsurfing.com+OR+site:trustpilot.com+OR+site:yelp.com+OR+site:tripadvisor.com+OR+site:foursquare.com+OR+site:untappd.com+OR+site:vivino.com+OR+site:cellartracker.com+OR+site:beeradvocate.com+OR+site:ratebeer.com+OR+site:allrecipes.com+OR+site:cookpad.com+OR+site:yummly.com+OR+site:tasty.co+OR+site:food52.com+OR+site:epicurious.com+OR+site:bonappetit.com+OR+site:seriouseats.com+OR+site:thekitchn.com+OR+site:apartmenttherapy.com+OR+site:houzz.com+OR+site:zillow.com+OR+site:redfin.com+OR+site:realtor.com+OR+site:trulia.com+OR+site:streetclams.com+OR+site:city-data.com+OR+site:topix.com+OR+site:fark.com+OR+site:slashdot.org+OR+site:digg.com+OR+site:newsvine.com+OR+site:mewe.com+OR+site:vero.co+OR+site:ello.co+OR+site:steemit.com+OR+site:minds.com+OR+site:crunchbase.com+OR+site:glassdoor.com+OR+site:indeed.com+OR+site:monster.com+OR+site:careerbuilder.com+OR+site:ziprecruiter.com+OR+site:simplyhired.com+OR+site:dice.com+OR+site:hired.com+OR+site:triplebyte.com+OR+site:remote.com+OR+site:weworkremotely.com+OR+site:flexjobs.com+OR+site:remotive.io+OR+site:jobspresso.co+OR+site:outsourcely.com+OR+site:hubstafftalent.com+OR+site:jsfiddle.net+OR+site:stackblitz.com+OR+site:replit.com+OR+site:glitch.com+OR+site:codesandbox.io+OR+site:sourceforge.net+OR+site:launchpad.net+OR+site:gitee.com+OR+site:coding.net+OR+site:dev.to+OR+site:hashnode.com+OR+site:hackernoon.com+OR+site:freecodecamp.org+OR+site:codecademy.com+OR+site:coursera.org+OR+site:edx.org+OR+site:udacity.com+OR+site:udemy.com+OR+site:pluralsight.com+OR+site:skillshare.com+OR+site:masterclass.com+OR+site:khanacademy.org+OR+site:youjizz.com+OR+site:spankbang.com+OR+site:xtube.com+OR+site:pornerbros.com+OR+site:pornhd.com+OR+site:pornrabbit.com+OR+site:pornmd.com+OR+site:porndig.com+OR+site:porndrive.com+OR+site:pornheed.com+OR+site:pornkee.com+OR+site:pornkyu.com+OR+site:pornluv.com+OR+site:pornmuz.com+OR+site:pornoat.com+OR+site:pornpics.com+OR+site:pornrox.com+OR+site:pornstar.com+OR+site:porntube.com+OR+site:pornvibe.com+OR+site:pornx.com+OR+site:pornz.com+OR+site:speedrun.com+OR+site:nexusmods.com+OR+site:curseforge.com+OR+site:moddb.com+OR+site:gamejolt.com+OR+site:itch.io+OR+site:kongregate.com+OR+site:newgrounds.com+OR+site:armorgames.com+OR+site:miniclip.com+OR+site:ubisoftconnect.com+OR+site:socialclub.rockstargames.com+OR+site:worldofwarcraft.com+OR+site:tracker.gg+OR+site:bungie.net+OR+site:pathofexile.com+OR+site:forums.warframe.com+OR+site:evewho.com+OR+site:opensea.io+OR+site:rarible.com+OR+site:foundation.app+OR+site:superrare.com+OR+site:looksrare.org+OR+site:magiceden.io+OR+site:coinmarketcap.com+OR+site:binance.com+OR+site:coinbase.com+OR+site:fitbit.com+OR+site:connect.garmin.com+OR+site:myfitnesspal.com+OR+site:trainingpeaks.com+OR+site:mapmyrun.com+OR+site:runkeeper.com+OR+site:onepeloton.com+OR+site:zwift.com+OR+site:chess.com+OR+site:lichess.org+OR+site:boardgamegeek.com+OR+site:reverbnation.com+OR+site:audiomack.com+OR+site:spotify.com+OR+site:deezer.com+OR+site:tidal.com+OR+site:forum.xda-developers.com+OR+site:forums.macrumors.com+OR+site:overclock.net+OR+site:linustechtips.com+OR+site:forums.tomshardware.com+OR+site:neowin.net+OR+site:hardforum.com+OR+site:forums.guru3d.com+OR+site:techpowerup.com+OR+site:pcpartpicker.com+OR+site:head-fi.org+OR+site:avsforum.com+OR+site:blu-ray.com+OR+site:forums.digitalspy.com+OR+site:pistonheads.com+OR+site:bimmerpost.com+OR+site:rennlist.com+OR+site:teslamotorsclub.com+OR+site:flyertalk.com+OR+site:nomadlist.com+OR+site:internations.org+OR+site:expat.com+OR+site:eventbrite.com+OR+site:mofos.com+OR+site:babes.com+OR+site:twistys.com+OR+site:trueamateur.com+OR+site:digitalplayground.com+OR+site:men.com+OR+site:seancody.com+OR+site:belami.com+OR+site:corbinfisher.com+OR+site:nextdoorstudios.com+OR+site:helixstudios.com+OR+site:falconstudios.com+OR+site:lucasentertainment.com+OR+site:cockyboys.com+OR+site:treasureislandmedia.com+OR+site:mix.com+OR+site:weheartit.com+OR+site:letterboxd.com+OR+site:app.thestorygraph.com+OR+site:librarything.com+OR+site:rateyourmusic.com+OR+site:anilist.co+OR+site:kitsu.io+OR+site:raider.io+OR+site:op.gg+OR+site:u.gg+OR+site:lolchess.gg+OR+site:dotabuff.com+OR+site:hltv.org+OR+site:osu.ppy.sh+OR+site:etherscan.io+OR+site:bscscan.com+OR+site:solscan.io+OR+site:polygonscan.com+OR+site:blockchain.com+OR+site:coingecko.com+OR+site:tradingview.com+OR+site:stocktwits.com+OR+site:bluesky.social+OR+site:bsky.app+OR+site:lemmy.world+OR+site:kbin.social+OR+site:matrix.org+OR+site:element.io+OR+site:rocket.chat+OR+site:zulip.com+OR+site:debank.com+OR+site:zapper.fi+OR+site:zerion.io+OR+site:nansen.ai+OR+site:dune.com+OR+site:faceit.com+OR+site:esea.net+OR+site:challengermode.com+OR+site:battlefy.com+OR+site:clover.co+OR+site:her.com';
...
export const OSINT_TOOLS: OSINTTool[] = [
  ...
  },
  {
    ...
    searchUrl: `https://www.google.com/search?q="{query}"+recon+-inurl:login+-inurl:signin+-inurl:signup+(${GLOBAL_SOCIAL_NSFW_DORK})`,
    category: 'Frameworks & Suites',
  ...
  },
  {
    ...
    searchUrl: `https://www.google.com/search?q="{query}"+account+-inurl:login+-inurl:signin+-inurl:signup+(${GLOBAL_SOCIAL_NSFW_DORK})`,
    category: 'Email & Username',
  ...
  },
  {
    ...
    searchUrl: `https://www.google.com/search?q="{query}"+google+account+-inurl:login+-inurl:signin+-inurl:signup+(${GLOBAL_SOCIAL_NSFW_DORK})`,
    category: 'Email & Username',
